...
Seis pastas e uma ordem total. Cada uma importa das de baixo, nunca das de cima — e há um teste
...
cima é ler o sistema na ordem em que ele foi construído.
    ...
    routes/     a porta HTTP. Cinco arquivos, um por público (convidado, host, busca, estado).
    ...
    domain/     as regras da festa: convidado, faixa, fila, play, guardas de voto.
...
Normativas, em `.docs/03-arquitetura.md` §6, e testadas:
    ...
    R3  spotify/ não conhece o banco: importa só core/
